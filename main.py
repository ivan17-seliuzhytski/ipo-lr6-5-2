...
# - Выводит сумму всех отрицательныхэ элементов.
...
nums = [-3, -5, -2, -12, 0, 15, 4, 7, 2] # Список возможных значений для заполнения матрицы.
matrix = [] # Создаем пустой список для хранения строк матрицы.
for i in range(height): # Генерируем строки матрицы для каждой строки в диапазоне высоты матрицы.
	...
	for j in range(width):# Заполняем строку элементами для каждого элемента в строке (в пределах ширины).
		row.append(random.choice(nums)) # Добавляем случайный элемент из списка nums.
...
print(f"Сумма всех отрицательных элементов: {summ}") # Выводим на экран сумму всех отрицательных элементов.
